...
(cl:in-package orb_slam3_ros-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SaveMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SaveMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name orb_slam3_ros-srv:<SaveMap-request> is deprecated: use orb_slam3_ros-srv:SaveMap-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <SaveMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam3_ros-srv:name-val is deprecated.  Use orb_slam3_ros-srv:name instead.")
  (name m))
...
(cl:defmethod cl:initialize-instance :after ((m <SaveMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SaveMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name orb_slam3_ros-srv:<SaveMap-response> is deprecated: use orb_slam3_ros-srv:SaveMap-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SaveMap-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam3_ros-srv:success-val is deprecated.  Use orb_slam3_ros-srv:success instead.")
  (success m))
