...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/av2/catkin_ws/src/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/av2/catkin_ws/devel/.private/cv_bridge)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/av2/catkin_ws/install)
...
if(NOT "/home/av2/catkin_ws/src/vision_opencv/cv_bridge/include;/usr/local/include/opencv4 " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/av2/catkin_ws/src/vision_opencv/cv_bridge/include;/usr/local/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/av2/catkin_ws/src/vision_opencv/cv_bridge/${idir}'.  ${_report}")
    endif()
    _list_append_unique(cv_bridge_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "cv_bridge;/usr/local/lib/libopencv_calib3d.so.4.9.0;/usr/local/lib/libopencv_dnn.so.4.9.0;/usr/local/lib/libopencv_features2d.so.4.9.0;/usr/local/lib/libopencv_flann.so.4.9.0;/usr/local/lib/libopencv_gapi.so.4.9.0;/usr/local/lib/libopencv_highgui.so.4.9.0;/usr/local/lib/libopencv_ml.so.4.9.0;/usr/local/lib/libopencv_objdetect.so.4.9.0;/usr/local/lib/libopencv_photo.so.4.9.0;/usr/local/lib/libopencv_stitching.so.4.9.0;/usr/local/lib/libopencv_video.so.4.9.0;/usr/local/lib/libopencv_videoio.so.4.9.0;/usr/local/lib/libopencv_core.so.4.9.0;/usr/local/lib/libopencv_imgproc.so.4.9.0;/usr/local/lib/libopencv_imgcodecs.so.4.9.0")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/av2/catkin_ws/devel/.private/cv_bridge/lib;/home/av2/catkin_ws/devel/lib;/opt/ros/melodic/lib)
